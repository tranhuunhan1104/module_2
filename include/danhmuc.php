...
$sql_cate = mysqli_query($con, "SELECT * FROM tb_category,tb_sanpham WHERE tb_category.category_id=tb_sanpham.category_id AND tb_category.category_id='$id'
							 ORDER BY tb_sanpham.sanpham_id DESC");
$sql_category = mysqli_query($con, "SELECT * FROM tb_category,tb_sanpham WHERE tb_category.category_id=tb_sanpham.category_id AND tb_category.category_id='$id'
							 ORDER BY tb_sanpham.sanpham_id DESC");

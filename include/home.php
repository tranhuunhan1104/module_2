		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						<?php
						$sql_cate_home = mysqli_query($con, "SELECT * FROM tb_category ORDER BY category_id DESC");
						...
						?>
							...
							<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
								...
								<div class="row">
									<?php
									$sql_product = mysqli_query($con, " SELECT * FROM tb_sanpham ORDER BY sanpham_id DESC");
													...
													<div class="men-thumb-item text-center">
														...
														<div class="men-cart-pro">
															<div class="inner-men-cart-pro">
																<a href="?quanli=chitietsp&id=<?php echo $row_sanpham['sanpham_id'] ?>" class="link-product-add-cart">Xem sản phẩm</a>
															</div>
														</div>
													</div>
													<div class="item-info-product text-center border-top mt-4">
														<h4 class="pt-1">
															<a href="?quanli=chitietsp&id=<?php echo $row_sanpham['sanpham_id'] ?>"><?php echo $row_sanpham['sanpham_name'] ?></a>
														</h4>
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="left-side border-bottom py-2">
							...
							<ul>
								<?php
								$sql_category = mysqli_query($con, 'SELECT * FROM tb_category ORDER BY category_id DESC');
								while ($row_category_sidebar = mysqli_fetch_array($sql_category)) {
								?>
									<li>
						...
						<div class="f-grid py-2">
							...
							<div class="box-scroll">
								<div class="scroll">
									<?php
									$sql_product_sidebar = mysqli_query($con, " SELECT * FROM tb_sanpham WHERE sanpham_hot='0'ORDER BY sanpham_id DESC");
